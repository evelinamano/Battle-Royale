...
$tool_content .="
    <tr>
      <th class=\"left\" height=\"32\">$langLabel :</th>
      <td class=\"right\"><a href=\"".$safe_self."?cmd=createLabel\">".$langCreate."</a></td>
    </tr>";
}
$tool_content .="
    <tr>
...
if (isset($displayChangePosForm) && $displayChangePosForm)
{
    ...
    <tr>
      ...
      <td class=\"right\">
        <form action=\"".$safe_self."\" method=\"post\">\"<b>".$moduleInfos['name']."</b>\" &nbsp;".$langTo.":&nbsp;&nbsp;";
...
foreach ($flatElementList as $module)
{
    ...
    {
        $tool_content .= "<a href=\"".$safe_self."?cmd=mkBlock&amp;cmdid=".$module['learnPath_module_id']."\">
	<img src=\"".$imgRepositoryWeb."unblock.gif\" alt=\"$langBlock\" title=\"$langBlock\" border=0></a>";
    }
    elseif( $module['lock'] == 'CLOSE')
    {
        $tool_content .= "<a href=\"".$safe_self."?cmd=mkUnblock&amp;cmdid=".$module['learnPath_module_id']."\">
    ...
    // DISPLAY CATEGORY MOVE COMMAND
    	$tool_content .= "<td style=\"border-left: 1px solid #edecdf;\">
	<a href=\"".$safe_self."?cmd=changePos&amp;cmdid=".$module['learnPath_module_id']."\">
	...
	<a href=\"".$safe_self."?cmd=moveUp&amp;cmdid=".$module['learnPath_module_id']."\">
	...
	<a href=\"".$safe_self."?cmd=moveDown&amp;cmdid=".$module['learnPath_module_id']."\">
   ...
   //in case of SCORM module, the pop-up window to confirm must be different as the action will be different on the server
    $tool_content .= "
      <td><a href=\"".$safe_self."?cmd=delModule&amp;cmdid=".$module['learnPath_module_id']."\" ".
    ...
    if ($module['visibility'] == 'HIDE') {
        $tool_content .= "<a href=\"".$safe_self."?cmd=mkVisibl&amp;cmdid=".$module['module_id']."\"><img src=\"".$imgRepositoryWeb."invisible.gif\" alt=\"$langVisible\" title=\"$langVisible\" border=\"0\"></a>";
    }
    else
    {
        ...
        $tool_content .= "<a href=\"".$safe_self."?cmd=mkInvisibl&amp;cmdid=".$module['module_id']."\" ".$onclick. " ><img src=\"".$imgRepositoryWeb."visible.gif\" alt=\"$langVisible\" title=\"$langVisible\" border=0></a>";
    }
