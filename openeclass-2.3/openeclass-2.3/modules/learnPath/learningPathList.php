...
while ($list = mysql_fetch_array($result)) // while ... learning path list
{
    ...
    if($is_adminOfCourse) {
        ...
        if ($list['lock'] == 'OPEN') {
            $tool_content .= "<a href='".$safe_self."?cmd=mkBlock&amp;cmdid=".$list['learnPath_id']."'>"
                  ."<img src='../../template/classic/img/unblock.gif' alt='$langBlock' title='$langBlock' />"
                  ."</a>";
        } else {
            $tool_content .= "<a href='".$safe_self."?cmd=mkUnblock&amp;cmdid=".$list['learnPath_id']."'>"
        ...
        // EXPORT links
        $tool_content .= '      <td align="center"><a href="'.$safe_self.'?cmd=export&amp;path_id=' . $list['learnPath_id'] . '" >'
            .'<img src="../../template/classic/img/export.gif" alt="'.$langExport2004.'" title="'.$langExport2004.'" /></a>' .""
            .'<a href="' . $safe_self . '?cmd=export12&amp;path_id=' . $list['learnPath_id'] . '" >'
        ...
        if ( $list['visibility'] == 'HIDE') {
            $tool_content .= "<a href='".$safe_self."?cmd=mkVisibl&amp;visibility_path_id=".$list['learnPath_id']."'>"
            ...
            $tool_content .= "<a href='".$safe_self."?cmd=mkInvisibl&amp;visibility_path_id=".$list['learnPath_id']."' ".$onclick. " >"
        ...
        if (is_dir($real)) {
            $tool_content .=  "      <td align='center'>"
                  ."<a href='".$safe_self."?cmd=delete&amp;del_path_id=".$list['learnPath_id']."' "
        ...
        if ($iterator != 1) {
            $tool_content .= "      <td class='right'>"
                  ."<a href='".$safe_self."?cmd=moveUp&amp;move_path_id=".$list['learnPath_id']."'>"
        ...
        if($iterator < $LPNumber) {
            $tool_content .= "      <td class='left'>"
                  ."<a href='".$safe_self."?cmd=moveDown&amp;move_path_id=".$list['learnPath_id']."'>"
