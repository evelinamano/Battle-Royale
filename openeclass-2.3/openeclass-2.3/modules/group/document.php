...
$tool_content .= "
    <div id='operations_container'>
      <ul id='opslist'><li><a href='group_space.php?$groupset'>$langGroupSpaceLink</a></li>
        ...
        <li><a href='". $safe_self ."?$groupset&amp;createDir=".$curDirPath."'>$langCreateDir</a></li>
        <li><a href='". $safe_self ."?$groupset&amp;uploadPath=".$curDirPath."'>$langDownloadFile</a></li>
      </ul>
    </div>";
...
if(isset($uploadPath)) {
	$tool_content .= <<<cData
	<form action='". $safe_self ."' method='post' enctype='multipart/form-data'>
	<input type='hidden' name='userGroupId' value='$userGroupId' />
...
{
	$tool_content .= "<a href='". $safe_self ."?$groupset&amp;openDir=".$parentDir."'>$langUp\n" .
...
if (isset($dirNameList))
{
	while (list($dirKey, $dirName) = each($dirNameList))
	{
		...
		$tool_content .= "\n    <tr>";
		$tool_content .= "\n        <td width=\"1\">";
		$tool_content .= "<a href='". $safe_self ."?$groupset&amp;openDir=$cmdDirName'".@$style.">\n";
		...
		$tool_content .= "\n        <td>&nbsp;</td>";
                if ($is_tutor or $is_adminOfCourse) {
                        /*** move command ***/
                        $tool_content .= "\n        <td width=\"1\"><a href=\"". $safe_self ."?$groupset&amp;move=".$cmdDirName."\">
                        <img src=\"../../template/classic/img/move_doc.gif\" border=0 title=\"$langMove\"></a></td>\n";
                        /*** rename command ***/
                        $tool_content .= "\n        <td width=\"1\"><a href=\"". $safe_self ."?$groupset&amp;rename=".$cmdDirName."\">
                        <img src=\"../../template/classic/img/edit.gif\" border=0 title=\"$langRename\"></a></td>\n";
                        /*** delete command ***/
                        $tool_content .= "\n        <td width=\"1\"><a href=\"". $safe_self ."?$groupset&amp;delete=".$cmdDirName."\" onClick=\"return confirmation();\"><img src=\"../../template/classic/img/delete.gif\" title=\"$langDelete\" border=0></a></td>\n";
                } else {
...
if (isset($fileNameList))
{
	while (list($fileKey, $fileName) = each ($fileNameList))
	{
		...
		if(empty($r["filename"])) { // compatibility
			$tool_content .=  "<a href='". $safe_self ."?$groupset&amp;action2=download&id=".$cmdFileName."' title=\"$langSave\">".$dspFileName."</a>";
		} else {
			$tool_content .= "<a href='". $safe_self ."?$groupset&amp;action2=download&id=$r[path]'>$r[filename]</a>";
		}
		$tool_content .= "</div></td>";
		/*** size ***/
		$tool_content .= "\n        <td>".$size."</td>\n";
		...
		<a href=\"../work/group_work.php?submit=$urlShortFileName\">$langPublish</a></td>\n";
                if ($is_tutor or $is_adminOfCourse) {
                        /*** copy command ***/
                        $tool_content .= "\n        <td><a href=\"". $safe_self ."?$groupset&amp;move=".$cmdFileName."\">
                        <img src=\"../../template/classic/img/move_doc.gif\" border=0></a></td>\n";
                        /*** rename command ***/
                        $tool_content .= "\n        <td><a href=\"". $safe_self ."?$groupset&amp;rename=".$cmdFileName."\">
                        <img src=\"../../template/classic/img/edit.gif\" border=0></a></td>\n";
                        /*** delete command ***/
                        @$tool_content .= "\n        <td><a href=\"". $safe_self ."?$groupset&amp;delete=".$cmdFileName."\" onClick=\"return confirmation();\">
