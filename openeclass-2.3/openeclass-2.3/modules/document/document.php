...
{       // teacher only
	...
	******************************************/
	...
	if (isset($comment))
	{
		...
		$dialogBox .="	<form method=\"post\" action=\"". $safe_self ."?edit_metadata\">
...
if($is_adminOfCourse) {
	...
	Create new folder
	--------------------------------------*/
	$tool_content .= "\n      <li><a href='". $safe_self ."?createDir=".$cmdCurDirPath."'>$langCreateDir</a></li>";
        ...
        foreach (array(true, false) as $is_dir) {
                foreach ($fileinfo as $entry) {
                        ...
                        if ($is_dir) {
                                ...
                                $file_url = "". $safe_self ."?openDir=$cmdDirName";
                                $link_extra = '';
