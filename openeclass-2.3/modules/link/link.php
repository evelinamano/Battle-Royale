...
if($is_adminOfCourse) {
	...
	if (isset($category))
	$tool_content .=  "
        <li><a href=\"".$safe_self."?action=addlink&amp;category=".$category."&amp;urlview=@$urlview\">".$langLinkAdd."</a></li>";
	else
	$tool_content .=  "
        <li><a href=\"".$safe_self."?action=addlink\">".$langLinkAdd."</a></li>";
	if (isset($urlview))
	$tool_content .=  "
        <li><a href=\"".$safe_self."?action=addcategory&amp;urlview=".$urlview."\">".$langCategoryAdd."</a></li>";
	else
	$tool_content .=  "
        <li><a href=\"".$safe_self."?action=addcategory\">".$langCategoryAdd."</a></li>";
	...
	if (isset($action) and ($action=="addlink" or $action=="editlink") and !isset($submitLink))
	{
		...
		{$category=0;}
		$tool_content .= "<form method=\"post\" action=\"".$safe_self."?action=".$action."&amp;urlview=".@$urlview."\" onsubmit=\"return checkrequired(this, 'urllink');\">";
		if ($action=="editlink")
	...
	{
		$tool_content .=  "
          <form method=\"post\" action=\"".$safe_self."?action=".$action."&amp;urlview=".@$urlview."\">";
		$tool_content .=  "
...
if (mysql_num_rows($resultcategories) > 0) {
    ...
    <tr>
      ...
      <th class=\"left\" style=\"border: 1px solid #edecdf;\" width=\"70\"><a href=\"".$safe_self."?urlview=";
	...
	while ($myrow=@mysql_fetch_array($resultcategories))
	{
      ...
      <td colspan=\"2\"><a href=\"".$safe_self."?urlview=".$newurlview."\">".q($myrow["categoryname"])."</a>";
    ...
    <tr class=\"odd\">
      ...
      <td colspan=\"2\"><a href=\"".$safe_self."?urlview=";
